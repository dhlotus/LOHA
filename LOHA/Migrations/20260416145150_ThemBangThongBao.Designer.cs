...
namespace LOHA.Migrations
{
    ...
    [Migration("20260416145150_ThemBangThongBao")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LOHA.Models.BaoCaoBaiViet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LOHA.Models.BaoCaoNguoiDung", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("NguoiBiBaoCaoId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LOHA.Models.NhatKyHoatDongAdmin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("AdminThucHien")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("LOHA.Models.ThongBao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LOHA.Models.TinNhan", b =>
                {
                    ...
                    b.Property<bool>("DaXoaBoiNguoiGui")
                        .HasColumnType("bit");

                    b.Property<bool>("DaXoaBoiNguoiNhan")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("LOHA.Models.BaoCaoBaiViet", b =>
                {
                    ...
                    b.HasOne("LOHA.Models.User", "NguoiBaoCao")
                        .WithMany()
            ...
            modelBuilder.Entity("LOHA.Models.BaoCaoNguoiDung", b =>
                {
                    ...
                    b.HasOne("LOHA.Models.User", "NguoiBiBaoCao")
                        .WithMany()
